...
def generate_launch_description():
    ...
    # bring in the main robot launch so Gazebo and controllers start first
    ...
    # wait a bit before opening the GUI — controllers need time to come up
    gui_node = Node(
    ...
    return LaunchDescription([
        main_launch,
        TimerAction(
            period=15.0,  # 15 s is usually enough for Gazebo + controllers to be ready
            actions=[gui_node]
        )
    ])
